...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'yuiEA@dbcegoa.com',
  ...
  title: "lrpli's OneDrive",

  // The folder that you are to share publicly with onedrive-vercel-index. Use '/' if you want to share your root folder.
  baseDirectory: '/学习资料（仅供学习使用）',
  ...
  email: 'mailto:io@lrpli.onmicrosoft.com',
